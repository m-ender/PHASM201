...
! deviation from the equilibrium water level, as opposed to the
! water depth. This is following a method proposed by Rogers et al.
! (2003) in "Mathematical balancing of flux gradient and source
! terms prior to using Roe's approximate Riemann solver".
